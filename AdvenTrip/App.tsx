...
import { AdventureSettings } from './components/AdventureSettings';
    ...
    <UserContext.Provider value={{ 
      ...
      <div className="min-h-screen bg-background">
        <Routes>
          ...
          <Route path="/adventure/:adventureId/settings" element={user ? <AdventureSettingsPage /> : <Navigate to="/get-started" />} />
        </Routes>
...
// Adventure Settings Page Component (/adventure/:adventureId/settings)
function AdventureSettingsPage() {
  const { adventureRequests, setAdventureRequests } = useUser();
  const navigate = useNavigate();
  ...
  const handleSave = (updatedRequest: AdventureRequest) => {
    setAdventureRequests(prev =>
